...
from app.validations.buyer_validation import validate_buyer_data
...
def create():
    ...
    validationError = validate_buyer_data(data)
    if validationError:
        return jsonify(validationError[0]), validationError[1]

    response, status_code = create_buyer(data)
